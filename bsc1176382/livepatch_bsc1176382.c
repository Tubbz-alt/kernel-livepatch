...
static int livepatch_bsc1176382_module_notify(struct notifier_block *nb,
...
static struct notifier_block livepatch_bsc1176382_module_nb = {
	.notifier_call = livepatch_bsc1176382_module_notify,
	.priority = INT_MIN+1,
};
...
int livepatch_bsc1176382_init(void)
{
	...
	ret = register_module_notifier(&livepatch_bsc1176382_module_nb);
out:
...
{
	unregister_module_notifier(&livepatch_bsc1176382_module_nb);
}
