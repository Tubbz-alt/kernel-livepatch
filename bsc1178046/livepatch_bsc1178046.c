 ...
 *  -1 line, +1 line
 */
static int klpp_btrfs_can_overcommit(struct btrfs_fs_info *fs_info,
				 ...
				 struct btrfs_space_info *space_info)
{
	 ...
	 *  -1 line, +1 line
	 */
	if (klpp_btrfs_can_overcommit(fs_info, space_info, to_reclaim,
			   BTRFS_RESERVE_FLUSH_ALL))
		return 0;
	 ...
	 *  -1 line, +2 lines
	 */
	if (klpp_btrfs_can_overcommit(fs_info, space_info, SZ_1M,
				 BTRFS_RESERVE_FLUSH_ALL))
